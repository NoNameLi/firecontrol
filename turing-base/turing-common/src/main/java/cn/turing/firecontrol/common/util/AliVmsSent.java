...
public class AliVmsSent {
    ...
    private String accessKeyId; //访问阿里云API的密钥
    private String accessKeySecret; //访问阿里云API的密钥
    private String calledNumber; //被叫显示号码

    public AliVmsSent(String accessKeyId,String accessKeySecret,String calledNumber){
     ...
     */
    private  SingleCallByTtsResponse singleCallByTts() throws ClientException {
     ...
     * @throws ClientException
     */
    public  SingleCallByTtsResponse sendAlarm(String templateId, String phone, Map<String,String> params) throws ClientException {
        ...
        SingleCallByTtsRequest request = new SingleCallByTtsRequest();
        //必填-被叫显号,可在语音控制台中找到所购买的显号
        request.setCalledShowNumber(calledNumber);
        //必填-被叫号码
        request.setCalledNumber(phone);
        //必填-Tts模板ID
        request.setTtsCode(templateId);
        //可选-当模板中存在变量时需要设置此值
        request.setTtsParam(JSON.toJSONString(params));
        //可选-外部扩展字段,此ID将在回执消息中带回给调用方
...
//        System.out.println("CallId=" + ivrCallResponse.getCallId());
        String phone ="13476008959";
        Map<String,String> params = new HashMap();
//        params.put("building","未来之光7号13楼电梯旁");
//        params.put("deviceSeries","电气火灾探测器");
//        params.put("alrmType","报警");
        params.put("deviceName","测试摄像头");
        AliVmsSent senter = new AliVmsSent("LTAISrSrk22dFvak","ypq2b7R5Rp73xwdhw69QNcKL1Iaif9","073182707270");
//        SingleCallByTtsResponse singleCallByTtsResponse = senter.sendAlarm("TTS_149390304",phone,params);
        SingleCallByTtsResponse singleCallByTtsResponse = senter.sendAlarm("TTS_158491062",phone,params);
        System.out.println("文本转语音外呼---------------");
        System.out.println("RequestId=" + singleCallByTtsResponse.getRequestId());
        System.out.println("Code=" + singleCallByTtsResponse.getCode());
        System.out.println("Message=" + singleCallByTtsResponse.getMessage());
