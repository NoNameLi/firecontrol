package cn.turing.firecontrol.core.context;


import cn.turing.firecontrol.core.constants.CommonConstants;
import cn.turing.firecontrol.core.util.StringHelper;
...
public class BaseContextHandler {
    ...
    public static void setIsSuperAdmin(String isSuperAdmin){
        set(CommonConstants.CONTEXT_KEY_IS_SUPER_ADMIN,isSuperAdmin);
    }

    public static String getIsSuperAdmin(){
        Object value = get(CommonConstants.CONTEXT_KEY_IS_SUPER_ADMIN);
        return StringHelper.getObjectValue(value);
    }

    public static void setIsTenantAdmin(String isTenantAdmin){
        set(CommonConstants.CONTEXT_KEY_IS_TENANT_ADMIN,isTenantAdmin);
    }

    public static String getIsTenantAdmin(){
        Object value = get(CommonConstants.CONTEXT_KEY_IS_TENANT_ADMIN);
        return StringHelper.getObjectValue(value);
    }
