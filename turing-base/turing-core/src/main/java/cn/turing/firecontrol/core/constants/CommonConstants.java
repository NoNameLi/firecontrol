package cn.turing.firecontrol.core.constants;
...
public class CommonConstants {
    ...
    public static final String CONTEXT_KEY_IS_SUPER_ADMIN = "isSuperAdmin";
    public static final String CONTEXT_KEY_IS_TENANT_ADMIN = "isTenantAdmin";
}
