...
public interface MenuMapper extends CommonMapper<Menu> {
    ...
    public List<Map<String,Object>> selectAllByGroupId(String groupId);

    public List<Menu> selectByTenantId(@Param("tenantId") String tenantId);

    public List<Menu> selectAllOfSuperAdmin();

    public List<String> selectByGroupId(@Param("groupId") String groupId);
