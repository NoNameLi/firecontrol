...
/**
 * @BelongsProject: firecontrol 所属项目
 * @BelongsPackage： cn.turing.firecontrol.datahandler.util 所属包
 * @Author: Administrator 作者
 * @CreateTime:2020-12-01 10:32
 * QDescription:描述
 */
@Slf4j
public class ESTransportUtilBack {

    private TransportClient transportClient;

    public ESTransportUtilBack(TransportClient transportClient) {
