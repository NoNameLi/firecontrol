...
//            byte[] buffer = new byte[8192];
    ...
    public static void main(String[] args) throws Exception{
        File file = new File("C:\\Users\\Administrator\\Desktop\\qcl.mp3");
        String pcmfilepath ="./src/a.pcm";
        AudioUtils.getInstance().convertMP32Pcm(file.getAbsolutePath(),pcmfilepath);
