...
public class ResponseCode {
	 ...
	 * 参数错误
	 */
	public static final int API_CODE_PARAM_ERROR=205;
	 ...
	 * 用户第一次登录
	 */
	public static final String API_CODE_USER_LOGS_FIRST_TIME = "\"362\"";

	/**
	 * 用户多次登录
	 */
	public static final String API_CODE_USER_MULTIPLE_LOGS= "\"363\"";

	/**
	 * 用户不存在
	 */
	public static final String API_CODE_USER_NOISEXIT = "\"364\"";
	/**
	 * 字段重复
	 */
	public static final int FIELD_REPEAT =  202;
	/**
	 * 参数不允许修改
	 */
	public static final int PARAM_NOT_MODIFY = 203;
	/**
	 * 删除错误
	 */
	public static final int DELETE_ERROR = 204;
