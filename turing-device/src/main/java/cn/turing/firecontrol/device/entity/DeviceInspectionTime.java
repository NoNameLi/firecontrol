...
@Table(name = "device_inspection_time")
public class DeviceInspectionTime implements Serializable {
    /**
     * 主键id
     */
    @Id
     ...
     * 巡检计划id
     */
    @Column(name = "INSPECTION_SCHEME_ID")
     ...
     * 获取巡检计划id
     *
     * @return INSPECTION_SCHEME_ID - 巡检计划id
     */
    public Integer getInspectionSchemeId() {
     ...
     */
    public void setInspectionSchemeId(Integer inspectionSchemeId) {
