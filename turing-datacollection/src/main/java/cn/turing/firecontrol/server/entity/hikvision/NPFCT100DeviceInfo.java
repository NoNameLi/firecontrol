package cn.turing.firecontrol.server.entity.hikvision;

import cn.turing.firecontrol.server.entity.hikvision.UplinkMessage.InformationSoftwareVersion;
import cn.turing.firecontrol.server.entity.hikvision.UplinkMessage.StatusOfBuildingFireServiceSystem;
import cn.turing.firecontrol.server.entity.hikvision.UplinkMessage.UploadUserInformationTransmission;
import lombok.Data;
...
public class NPFCT100DeviceInfo {
    ...
    public NPFCT100DeviceInfo(String s) {
      log.info("开始解析NP-FCT100型用户信息传输装置");
