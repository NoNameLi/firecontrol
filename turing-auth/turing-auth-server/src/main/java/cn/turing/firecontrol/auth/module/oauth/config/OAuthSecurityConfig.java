...
import cn.turing.firecontrol.auth.module.oauth.service.OauthUserDetailsService;
import cn.turing.firecontrol.core.constants.CommonConstants;
import cn.turing.firecontrol.core.util.RsaKeyHelper;
...
public class OAuthSecurityConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Bean
    public ClusterRedisTokenStore redisTokenStore(){
        ClusterRedisTokenStore redisTokenStore = new ClusterRedisTokenStore(redisConnectionFactory,byteRedisTemplate());
    ...
    public JwtAccessTokenConverter accessTokenConverter() throws IOException, InvalidKeyException, NoSuchAlgorithmException {
        ...
        JwtAccessTokenConverter accessTokenConverter = new JwtAccessTokenConverter() {
            ...
            public OAuth2AccessToken enhance(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
                ...
                additionalInformation.put("isSuperAdmin",user.getIsSuperAdmin());
                additionalInformation.put("isTenantAdmin",user.getIsTenantAdmin());
