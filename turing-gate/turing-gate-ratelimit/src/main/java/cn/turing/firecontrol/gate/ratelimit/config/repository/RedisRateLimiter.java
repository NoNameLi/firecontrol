...
package cn.turing.firecontrol.gate.ratelimit.config.repository;

import cn.turing.firecontrol.gate.ratelimit.config.Rate;
import cn.turing.firecontrol.gate.ratelimit.config.RateLimiter;
import cn.turing.firecontrol.gate.ratelimit.config.properties.RateLimitProperties.Policy;
