...
package cn.turing.firecontrol.gate.filter;

import cn.turing.firecontrol.gate.feign.ILogFeign;
import cn.turing.firecontrol.gate.feign.IUserFeign;
import cn.turing.firecontrol.gate.utils.DBLog;
...
import cn.turing.firecontrol.api.vo.log.LogInfo;
import cn.turing.firecontrol.auth.client.config.ServiceAuthConfig;
import cn.turing.firecontrol.auth.client.config.UserAuthConfig;
import cn.turing.firecontrol.auth.client.jwt.ServiceAuthUtil;
...
import cn.turing.firecontrol.common.exception.auth.UserForbiddenException;
import cn.turing.firecontrol.common.util.ClientUtil;
...
public class AdminAccessFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        //如果请求头包含ignoreUser且值为true则不拦截
        String ignoreUser = request.getHeader("ignoreUser");
        if(StringUtils.isNotBlank(ignoreUser) && "true".equals(ignoreUser)){
            return null;
        }
