 ...
 */
@Data
public class SprayDeviceInfoV1 extends RabbitDeviceInfo {
    private  Integer length;
    public SprayDeviceInfoV1(JSONObject jsonObject) throws Exception {
        super(jsonObject);
    ...
    public SensorDetail LiquidData(String str, String str1){
        ...
        BigDecimal bg = new BigDecimal(liquid(str,M1)).setScale(5, RoundingMode.UP);
    ...
    public  SensorDetail electricityData(String data){
        ...
        sensorDetail.setAlarmValue(bg.doubleValue()/3.7*100);
        return  sensorDetail;
    }
