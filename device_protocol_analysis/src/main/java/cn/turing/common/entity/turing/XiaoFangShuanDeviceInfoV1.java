...
@Data
public class XiaoFangShuanDeviceInfoV1 extends RabbitDeviceInfo {
    //以下为设备相关信息
    private String data;
    private String head;
...
//    private String address;
    ...
    public SensorDetail parseShuiYa(String input,String shuiya,String dianya){
        ...
        System.out.println("水压====:"+ByteUtil.shuiYaYunSuan(num,num1));
        return  sensorDetail;
    }
...
//        }
    ...
    public SensorDetail parseWuDu(String input,String input1){ //再定，温度有没有报警
       ...
       int num3=Integer.parseInt(input1,16);
        ...
        System.out.println("温度:==="+ByteUtil.wenduYunSuan(num2,num3));
        return  sensorDetail;
    }
