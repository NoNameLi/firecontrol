...
@Data
public class NBWaterImmersionDeviceInfoV1 extends RabbitDeviceInfo {
    ...
    public NBWaterImmersionDeviceInfoV1(JSONObject jsonObject) throws Exception {
    	super(jsonObject);
        try {
            ...
            if ("01".equalsIgnoreCase(CMD)){
                ...
                sign_value=Integer.parseInt(this.getData().substring(34,36),16)-110;
