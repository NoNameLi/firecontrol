...
@Data
public class SmokingDeviceInfoV2 extends RabbitDeviceInfo {
    ...
    public SmokingDeviceInfoV2(JSONObject jsonObject) throws Exception {
            super(jsonObject);
        try {
            ...
            if ("01".equalsIgnoreCase(CMD)){
                ...
                signal_value=Integer.parseInt(this.getData().substring(18,20),16);
